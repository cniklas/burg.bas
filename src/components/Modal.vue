			...
			<div class="modal" ref="modal">
				...
				<article class="story">
					...
					<p>
						...
						Nun wird diese alles entscheidende Szene in Form eines etwas schrägen Protokolls dargestellt und die Aussicht auf Sieg oder Niederlage von vielen Zufällen abhängig gemacht.
					</p>
					<p>
